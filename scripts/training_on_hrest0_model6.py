...
from train_hres_model6 import training, logger
import torch.optim as optim
from relative_loss import AuroraLoss
...
torch.save(model.state_dict(), "..model/training/hrest0/model6/best_hres_model.pth")
save_path  = "../report/training/hres/model6"
