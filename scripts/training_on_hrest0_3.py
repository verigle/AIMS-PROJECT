...
from train_hres3 import training, logger
import torch.optim as optim
from loss_weight import AuroraLoss
...
torch.save(model.state_dict(), "..model/training/hrest0/model5/best_hres_model.pth")
save_path  = "../report/training/hres/model5"
