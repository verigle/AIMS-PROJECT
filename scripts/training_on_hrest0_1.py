...
from train_hres1 import training, logger
...
torch.save(model.state_dict(), "..model/training/hrest0/model2/best_hres_model.pth")
save_path  = "../report/training/hres/model2"
