...
from train_hres2 import training, logger
...
torch.save(model.state_dict(), "..model/training/hrest0/model3/best_hres_model.pth")
save_path  = "../report/training/hres/model3"
