...
plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back.pdf", bbox_inches="tight")
plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back.png", bbox_inches="tight")
plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back.svg", bbox_inches="tight")
...
def plot(SELECTED_ATMOS_LEVELS, level=1):
    ...
    plt.tight_layout(pad=1.3)
    plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back_sup_atmos{level}.pdf", bbox_inches="tight")
    plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back_sup_atmos{level}.png", bbox_inches="tight")
    plt.savefig(f"{saving_path}/sa_vs_usa_vs_eu_back_sup_atmos{level}.svg", bbox_inches="tight")
