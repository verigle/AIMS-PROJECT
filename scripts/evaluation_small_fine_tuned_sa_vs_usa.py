...
checkpoint = torch.load('../model/training/hrest0/model8/checkpoint_epoch_6.pth')
...
for surf_var, rmses in target_region_surface_rmses.items():
    
    relative_surface_rmses[surf_var] = (target_region_surface_rmses[surf_var]-base_region_surface_rmses[surf_var])/base_region_surface_rmses[surf_var]*100
    

relative_atmospheric_rmses = {}
for atmos_var, rmses in target_region_atmospheric_rmses.items():
    
    relative_atmospheric_rmses[atmos_var] = (target_region_atmospheric_rmses[atmos_var]-base_region_atmospheric_rmses[atmos_var])/base_region_atmospheric_rmses[atmos_var]*100
...
save_path = "../report/evaluation/fine_tuned/sa_vs_usa"
...
all_values = np.concatenate(
    [relative_atmospheric_rmses[var].flatten() for var in target_region_atmospheric_rmses] +
    [relative_surface_rmses[var].flatten() for var in target_region_surface_rmses]
)
...
for i, variable in enumerate(target_region_atmospheric_rmses):
...
for j, variable in enumerate(target_region_surface_rmses):
