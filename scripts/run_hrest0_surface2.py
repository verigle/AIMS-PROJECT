...
for i in range(len(selected_times) - 3):
    ...
    world_predictions = predict_fn(model =model_initial ,batch=world_feature_batch)
...
# dict_clean = {"dates": pred_dates_list, "rmses": world_rmses_list["2t"]}
