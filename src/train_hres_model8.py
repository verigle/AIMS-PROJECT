...
from relative_loss3 import AuroraLoss
from utils import (
...
def training(model, criterion, num_epochs, optimizer, era5_data=None, hres_data=None,
             dataset_name="HRES", accumulation_steps=32, rollouts_num=8, checkpoint_dir='../model/training/hrest0/model8'):
